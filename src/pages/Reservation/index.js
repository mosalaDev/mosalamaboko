...
const Reservation = () => {
	...
	const handleGoToReservation = () => {
		...
		history.push(
			`/client/${user.username}/reservations/${createdReservation.id}`
		);
	};
	...
	const handleSubmit = () => {
		...
		dispatch(createReservation(data, token)).then((res) => {
			const d = res.payload;
			if (d && !d.code) {
				setIsFinished(true);
				...
				setErrors({
					...errors,
					server: "Une erreur s'est produite lors de la réservation. Veuillez reésayer plus tard.",
				});
			}
		});
	};
		...
		switch (step) {
			case 0:
				...
				if (!valid) {
					setErrors((errors) => ({
						...errors,
						services: "Selectionnez au moins un service.",
					}));
				} else {
			...
			case 4:
				...
				if (!valid) {
					setErrors((errors) => ({
						...errors,
						date: "Mauvaise date ou heure selectionnée. La date et l'heure ne doivent pas être inferieures à l'instant présent.",
					}));
				} else {
					...
					<div className={classes.formBlock}>
						<div className={classes.innerBlock}>
							<div className={classes.blockHeader}>
								...
								>
									Sélectionnez le service que vous voulez
									réserver.
								</Typography>
								{errors.services && (
						...
						<div className={classes.innerBlock}>
							...
							<div style={{ marginTop: 20 }} className="f-group">
								<TextInput
									...
									value={autresTravaux}
									onChange={(e) =>
										setAutresTravaux(e.target.value)
									}
								/>
							</div>
							<div
						...
						<div className={classes.innerBlock}>
							...
							<div className="f-group">
								...
								<div className={classes.position}>
									...
									>
										Si votre position actuelle est le lieu
										d'intervention, activez la locatisation.
									</Typography>
									<Switch
										name="coords"
	...
	return (
		<Modal
			...
			contentContainerStyles={{ padding: 0, borderRadius: 0 }}
		>
						...
						<div className={classes.infoContainer}>
							<div className={classes.infoInnerContainer}>
								...
								<Typography variant="h5" color="textPrimary">
									Merci d'avoir fait une réservation
								</Typography>
								<Typography
									variant="body1"
									color="textSecondary"
								>
									Votre demande est encours de traitement.
									Nous allons bientôt vous contacter pour la
					...
					<>
						...
						{loadingServices ? (
							...
							<div className={classes.body}>
								...
								<div
									className={classes.formBlockContainer}
									ref={fBRef}
								>
									{getStepContent(step)}
								</div>
